...
# 添加项目根目录到路径（tests/backend/ros2/msgs 向上 4 级）
sys.path.append(
    os.path.dirname(
...
from tests.backend.ros2.msgs.test_basic import TestBasicFunctionality
from tests.backend.ros2.msgs.test_conversion import TestBasicConversion, TestMappingConversion
from tests.backend.ros2.msgs.test_mapping import TestTypeMapping, TestFieldMapping
