...
from unilabos.server.services.runtime.workflow.catalog import PublishedWorkflowSource
from unilabos.server.services.runtime.workflow.handle_projection import (
    resource_slot_schema,
    structural_ready_handle,
    workflow_handle_type,
)
from unilabos.protocol.utils.json_codec import encode_json
from unilabos.protocol.runtime.workflow import validate_uuid
...
from unilabos.server.services.runtime.workflow.composite_expansion import (  # noqa: E402
    CompositeAuthoring,
    CompositeExpansion,
