...
from unilabos.server.services.workflow.catalog import PublishedWorkflowSource
from unilabos.server.services.workflow.handle_projection import (
    resource_slot_schema,
    structural_ready_handle,
    workflow_handle_type,
)
from unilabos.protocol.json_codec import encode_json
from unilabos.protocol.workflow import validate_uuid
...
from unilabos.server.services.workflow.composite_expansion import (  # noqa: E402
    CompositeAuthoring,
    CompositeExpansion,
