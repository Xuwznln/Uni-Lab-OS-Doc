...
Original: pylabrobot/liquid_handling/backends/hamilton/STAR_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.STARBackend")
...
class STARBackend(HamiltonLiquidHandler, HamiltonHeaterShakerInterface):
  ...
  def __init__(
    ...
    print("[UNILAB] STARBackend.__init__() called", flush=True)
  ...
  @property
  @action(auto_prefix=True, description="获取机械臂数量。")
  def num_arms(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.num_arms() called")
    return 1 if self.iswap_installed else 0

  @property
  @action(auto_prefix=True, description="获取是否安装96头。")
  def head96_installed(self) -> Optional[bool]:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_installed() called")
    return self.core96_head_installed

  @property
  @action(auto_prefix=True, description="获取高风险动作命名空间。")
  def unsafe(self) -> "UnSafe":
    _unilab_logger.debug("[UNILAB] STARBackend.unsafe() called")
    """Actions that have a higher risk of damaging the robot. Use with care!"""
    return self._unsafe

  @property
  @action(auto_prefix=True, description="获取移液通道数量。")
  def num_channels(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.num_channels() called")
  ...
  @action(auto_prefix=True, description="设置最小通过高度。")
  def set_minimum_traversal_height(self, traversal_height: float):
    _unilab_logger.debug("[UNILAB] STARBackend.set_minimum_traversal_height() called")
  ...
  @action(auto_prefix=True, description="设置通道最小通过高度。")
  def set_minimum_channel_traversal_height(self, traversal_height: float):
    _unilab_logger.debug("[UNILAB] STARBackend.set_minimum_channel_traversal_height() called")
  ...
  @action(auto_prefix=True, description="设置iSWAP最小通过高度。")
  def set_minimum_iswap_traversal_height(self, traversal_height: float):
    _unilab_logger.debug("[UNILAB] STARBackend.set_minimum_iswap_traversal_height() called")
  ...
  def iswap_minimum_traversal_height(self, traversal_height: float):
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_minimum_traversal_height() called")
  ...
  @property
  @action(auto_prefix=True, description="获取iSWAP通过高度。")
  def iswap_traversal_height(self) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_traversal_height() called")
    return self._iswap_traversal_height

  @property
  @action(auto_prefix=True, description="获取模块ID长度。")
  def module_id_length(self):
    _unilab_logger.debug("[UNILAB] STARBackend.module_id_length() called")
    return 2

  @property
  @action(auto_prefix=True, description="获取扩展配置。")
  def extended_conf(self) -> dict:
    _unilab_logger.debug("[UNILAB] STARBackend.extended_conf() called")
  ...
  @property
  @action(auto_prefix=True, description="获取iSWAP是否已停放。")
  def iswap_parked(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_parked() called")
    return self._iswap_parked is True

  @property
  @action(auto_prefix=True, description="获取CoRe夹爪是否已停放。")
  def core_parked(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.core_parked() called")
    return self._core_parked is True

  @action(auto_prefix=True, description="获取iSWAP版本。")
  async def get_iswap_version(self) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.get_iswap_version() called")
  ...
  @action(auto_prefix=True, description="获取指定PIP通道版本。")
  async def request_pip_channel_version(self, channel: int) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.request_pip_channel_version() called")
    return cast(
      str,
      (await self.send_command(STARBackend.channel_id(channel), "RF", fmt="rf" + "&" * 17))["rf"],
    )

  @action(auto_prefix=True, description="从固件响应中提取ID。")
  def get_id_from_fw_response(self, resp: str) -> Optional[int]:
    _unilab_logger.debug("[UNILAB] STARBackend.get_id_from_fw_response() called")
  ...
  @action(auto_prefix=True, description="解析并检查固件返回错误。")
  def check_fw_string_error(self, resp: str):
    _unilab_logger.debug("[UNILAB] STARBackend.check_fw_string_error() called")
  ...
  def _parse_response(self, resp: str, fmt: str) -> dict:
    _unilab_logger.debug("[UNILAB] STARBackend._parse_response() called")
  ...
  def _parse_firmware_version_datetime(self, fw_version: str) -> datetime.date:
    _unilab_logger.debug("[UNILAB] STARBackend._parse_firmware_version_datetime() called")
  ...
  @action(auto_prefix=True, description="执行整机初始化设置。")
  async def setup(
    self,
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.setup() called")
    ...
    async def set_up_pip():
      _unilab_logger.debug("[UNILAB] STARBackend.set_up_pip() called")
    ...
    async def set_up_autoload():
      _unilab_logger.debug("[UNILAB] STARBackend.set_up_autoload() called")
    ...
    async def set_up_iswap():
      _unilab_logger.debug("[UNILAB] STARBackend.set_up_iswap() called")
    ...
    async def set_up_core96_head():
      _unilab_logger.debug("[UNILAB] STARBackend.set_up_core96_head() called")
    ...
    async def set_up_arm_modules():
      _unilab_logger.debug("[UNILAB] STARBackend.set_up_arm_modules() called")
      await set_up_pip()
      await set_up_iswap()
  ...
  @action(auto_prefix=True, description="立即停止设备。")
  async def stop(self):
    _unilab_logger.debug("[UNILAB] STARBackend.stop() called")
    await super().stop()
    self._setup_done = False

  @property
  @action(auto_prefix=True, description="获取是否完成设置。")
  def setup_done(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.setup_done() called")
  ...
  @action(auto_prefix=True, description="查询通道最小Y间距。")
  async def channel_request_y_minimum_spacing(self, channel_idx: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.channel_request_y_minimum_spacing() called")
  ...
  @action(auto_prefix=True, description="检查通道是否可达指定位置。")
  def can_reach_position(self, channel_idx: int, position: Coordinate) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.can_reach_position() called")
  ...
  @action(auto_prefix=True, description="确保所选通道可达目标位置。")
  def ensure_can_reach_position(
    self, use_channels: List[int], ops: Sequence[PipettingOp], op_name: str
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.ensure_can_reach_position() called")
  ...
  @action(auto_prefix=True, description="拾取多个通道吸头。")
  async def pick_up_tips(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_tips() called")
  ...
  @action(auto_prefix=True, description="卸下多个通道吸头。")
  async def drop_tips(
    self,
    ops: List[Drop],
    use_channels: List[int],
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.drop_tips() called")
  ...
  def _assert_valid_resources(self, resources: Sequence[Resource]) -> None:
    _unilab_logger.debug("[UNILAB] STARBackend._assert_valid_resources() called")
  ...
  @action(auto_prefix=True, description="探测液面高度。")
  async def probe_liquid_heights(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.probe_liquid_heights() called")
  ...
  @action(auto_prefix=True, description="探测液体体积。")
  async def probe_liquid_volumes(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.probe_liquid_volumes() called")
  ...
  @action(auto_prefix=True, description="读取通道分液驱动当前位置。")
  async def channel_dispensing_drive_request_position(self, channel_idx: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.channel_dispensing_drive_request_position() called")
  ...
  @action(auto_prefix=True, description="将通道分液驱动移动到指定体积位置。")
  async def channel_dispensing_drive_move_to_volume_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.channel_dispensing_drive_move_to_volume_position() called")
  ...
  @action(auto_prefix=True, description="排空单个吸头中的液体。")
  async def empty_tip(
    self,
    channel_idx: int,
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.empty_tip() called")
  ...
  @action(auto_prefix=True, description="排空多个吸头中的液体。")
  async def empty_tips(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.empty_tips() called")
  ...
  @action(auto_prefix=True, description="执行通道吸液。")
  async def aspirate(
    self,
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.aspirate() called")
  ...
  @action(auto_prefix=True, description="执行通道分液。")
  async def dispense(
    self,
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.dispense() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="用96头拾取吸头。")
  async def pick_up_tips96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_tips96() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="用96头卸下吸头。")
  async def drop_tips96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.drop_tips96() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="使用96头吸液。")
  async def aspirate96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.aspirate96() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="使用96头分液。")
  async def dispense96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.dispense96() called")
  ...
  @action(auto_prefix=True, description="移动iSWAP夹持中的资源。")
  async def iswap_move_picked_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_move_picked_up_resource() called")
  ...
  @action(auto_prefix=True, description="用CoRe夹爪拾取资源。")
  async def core_pick_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_pick_up_resource() called")
  ...
  @action(auto_prefix=True, description="移动CoRe夹持中的资源。")
  async def core_move_picked_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_move_picked_up_resource() called")
    """After a resource is picked up, move it to a new location but don't release it yet.
    Low level component of :meth:`move_resource`
  ...
  @action(auto_prefix=True, description="释放CoRe夹持中的资源。")
  async def core_release_picked_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_release_picked_up_resource() called")
  ...
  @action(auto_prefix=True, description="拾取资源。")
  async def pick_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_resource() called")
    if use_arm == "iswap":
      assert (
  ...
  @action(auto_prefix=True, description="移动已抓取资源。")
  async def move_picked_up_resource(
    self, move: ResourceMove, use_arm: Literal["iswap", "core"] = "iswap"
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.move_picked_up_resource() called")
    center = (
      move.location
  ...
  @action(auto_prefix=True, description="放下已抓取资源。")
  async def drop_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.drop_resource() called")
  ...
  @action(auto_prefix=True, description="准备手动通道操作。")
  async def prepare_for_manual_channel_operation(self, channel: int):
    _unilab_logger.debug("[UNILAB] STARBackend.prepare_for_manual_channel_operation() called")
    """Prepare for manual operation."""

    await self.position_max_free_y_for_n(pipetting_channel_index=channel)

  @action(auto_prefix=True, description="移动单通道X轴。")
  async def move_channel_x(self, channel: int, x: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_x() called")
    """Move a channel in the x direction."""
    await self.position_left_x_arm_(round(x * 10))

  @need_iswap_parked
  @action(auto_prefix=True, description="移动单通道Y轴。")
  async def move_channel_y(self, channel: int, y: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_y() called")
  ...
  @action(auto_prefix=True, description="移动单通道Z轴。")
  async def move_channel_z(self, channel: int, z: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_z() called")
  ...
  @action(auto_prefix=True, description="相对移动单通道X轴。")
  async def move_channel_x_relative(self, channel: int, distance: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_x_relative() called")
  ...
  @action(auto_prefix=True, description="相对移动单通道Y轴。")
  async def move_channel_y_relative(self, channel: int, distance: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_y_relative() called")
  ...
  @action(auto_prefix=True, description="相对移动单通道Z轴。")
  async def move_channel_z_relative(self, channel: int, distance: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_channel_z_relative() called")
  ...
  @action(auto_prefix=True, description="检查通道是否可拾取吸头。")
  def can_pick_up_tip(self, channel_idx: int, tip: Tip) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.can_pick_up_tip() called")
    if not isinstance(tip, HamiltonTip):
      return False
  ...
  @action(auto_prefix=True, description="用CoRe夹爪检查位置中心是否有资源。")
  async def core_check_resource_exists_at_location_center(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_check_resource_exists_at_location_center() called")
  ...
  def _position_96_head_in_resource(self, resource: Resource) -> Coordinate:
    _unilab_logger.debug("[UNILAB] STARBackend._position_96_head_in_resource() called")
  ...
  def _check_96_position_legal(self, c: Coordinate, skip_z=False) -> None:
    _unilab_logger.debug("[UNILAB] STARBackend._check_96_position_legal() called")
  ...
  @action(auto_prefix=True, description="预初始化整机。")
  async def pre_initialize_instrument(self):
    _unilab_logger.debug("[UNILAB] STARBackend.pre_initialize_instrument() called")
    """Pre-initialize instrument"""
    return await self.send_command(module="C0", command="VI", read_timeout=300)

  @action(auto_prefix=True, description="定义吸头或针参数。")
  async def define_tip_needle(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.define_tip_needle() called")
  ...
  @action(auto_prefix=True, description="获取错误代码。")
  async def request_error_code(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_error_code() called")
    """Request error code
  ...
  async def request_firmware_version(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_firmware_version() called")
  ...
  @action(auto_prefix=True, description="获取参数值。")
  async def request_parameter_value(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_parameter_value() called")
  ...
  @action(auto_prefix=True, description="获取电子板类型。")
  async def request_electronic_board_type(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_electronic_board_type() called")
  ...
  # TODO: parse response.
  @action(auto_prefix=True, description="获取供电电压。")
  async def request_supply_voltage(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_supply_voltage() called")
  ...
  @action(auto_prefix=True, description="获取整机初始化状态。")
  async def request_instrument_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_instrument_initialization_status() called")
  ...
  @action(auto_prefix=True, description="获取autoload初始化状态。")
  async def request_autoload_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_autoload_initialization_status() called")
    """Request autoload initialization status"""

    resp = await self.send_command(module="I0", command="QW", fmt="qw#")
    return resp is not None and resp["qw"] == 1

  @action(auto_prefix=True, description="获取上次错误参数名称。")
  async def request_name_of_last_faulty_parameter(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_name_of_last_faulty_parameter() called")
  ...
  @action(auto_prefix=True, description="获取主控状态。")
  async def request_master_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_master_status() called")
  ...
  @action(auto_prefix=True, description="获取已安装存在传感器数量。")
  async def request_number_of_presence_sensors_installed(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_number_of_presence_sensors_installed() called")
  ...
  @action(auto_prefix=True, description="获取EEPROM数据正确性状态。")
  async def request_eeprom_data_correctness(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_eeprom_data_correctness() called")
  ...
  @action(auto_prefix=True, description="设置单步模式。")
  async def set_single_step_mode(self, single_step_mode: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.set_single_step_mode() called")
  ...
  @action(auto_prefix=True, description="触发下一单步。")
  async def trigger_next_step(self):
    _unilab_logger.debug("[UNILAB] STARBackend.trigger_next_step() called")
    """Trigger next step (Single step mode)"""

    # TODO: this command has no reply!!!!
    return await self.send_command(module="C0", command="NS")

  @action(auto_prefix=True, description="停止后续命令并完成当前序列。")
  async def halt(self):
    _unilab_logger.debug("[UNILAB] STARBackend.halt() called")
    """Halt
  ...
  @action(auto_prefix=True, description="保存所有循环计数器。")
  async def save_all_cycle_counters(self):
    _unilab_logger.debug("[UNILAB] STARBackend.save_all_cycle_counters() called")
  ...
  @action(auto_prefix=True, description="设置不停机模式。")
  async def set_not_stop(self, non_stop):
    _unilab_logger.debug("[UNILAB] STARBackend.set_not_stop() called")
    """Set not stop mode
  ...
  @action(auto_prefix=True, description="存储安装数据。")
  async def store_installation_data(
    self,
    date: datetime.datetime = datetime.datetime.now(),
    serial_number: str = "0000",
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.store_installation_data() called")
  ...
  @action(auto_prefix=True, description="存储验证数据。")
  async def store_verification_data(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.store_verification_data() called")
  ...
  @action(auto_prefix=True, description="写入附加时间戳。")
  async def additional_time_stamp(self):
    _unilab_logger.debug("[UNILAB] STARBackend.additional_time_stamp() called")
    """Additional time stamp"""

    return await self.send_command(module="C0", command="AT")

  @action(auto_prefix=True, description="设置X轴与iSWAP的X偏移。")
  async def set_x_offset_x_axis_iswap(self, x_offset: int):
    _unilab_logger.debug("[UNILAB] STARBackend.set_x_offset_x_axis_iswap() called")
  ...
  @action(auto_prefix=True, description="设置X轴与CoRe 96头的X偏移。")
  async def set_x_offset_x_axis_core_96_head(self, x_offset: int):
    _unilab_logger.debug("[UNILAB] STARBackend.set_x_offset_x_axis_core_96_head() called")
  ...
  @action(auto_prefix=True, description="设置X轴与纳升级移液头的X偏移。")
  async def set_x_offset_x_axis_core_nano_pipettor_head(self, x_offset: int):
    _unilab_logger.debug("[UNILAB] STARBackend.set_x_offset_x_axis_core_nano_pipettor_head() called")
    """Set X-offset X-axis <-> CoRe 96 head
  ...
  @action(auto_prefix=True, description="保存下载日期。")
  async def save_download_date(self, date: datetime.datetime = datetime.datetime.now()):
    _unilab_logger.debug("[UNILAB] STARBackend.save_download_date() called")
    """Save Download date
  ...
  @action(auto_prefix=True, description="保存组件技术状态。")
  async def save_technical_status_of_assemblies(self, processor_board: str, power_supply: str):
    _unilab_logger.debug("[UNILAB] STARBackend.save_technical_status_of_assemblies() called")
  ...
  @action(auto_prefix=True, description="设置仪器配置。")
  async def set_instrument_configuration(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.set_instrument_configuration() called")
  ...
  @action(auto_prefix=True, description="保存PIP通道验证状态。")
  async def save_pip_channel_validation_status(self, validation_status: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.save_pip_channel_validation_status() called")
  ...
  @action(auto_prefix=True, description="保存XL通道验证状态。")
  async def save_xl_channel_validation_status(self, validation_status: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.save_xl_channel_validation_status() called")
  ...
  # TODO: response
  @action(auto_prefix=True, description="配置节点名称。")
  async def configure_node_names(self):
    _unilab_logger.debug("[UNILAB] STARBackend.configure_node_names() called")
    """Configure node names"""

    return await self.send_command(module="C0", command="AJ")

  @action(auto_prefix=True, description="设置deck数据。")
  async def set_deck_data(self, data_index: int = 0, data_stream: str = "0"):
    _unilab_logger.debug("[UNILAB] STARBackend.set_deck_data() called")
    """set deck data
  ...
  @action(auto_prefix=True, description="获取组件技术状态。")
  async def request_technical_status_of_assemblies(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_technical_status_of_assemblies() called")
    """Request Technical status of assemblies"""

    # TODO: parse res
    return await self.send_command(module="C0", command="QT")

  @action(auto_prefix=True, description="获取安装数据。")
  async def request_installation_data(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_installation_data() called")
    """Request installation data"""

    # TODO: parse res
    return await self.send_command(module="C0", command="RI")

  @action(auto_prefix=True, description="获取设备序列号。")
  async def request_device_serial_number(self) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.request_device_serial_number() called")
    """Request device serial number"""
    return (await self.send_command("C0", "RI", fmt="si####sn&&&&sn&&&&"))["sn"]  # type: ignore

  @action(auto_prefix=True, description="获取下载日期。")
  async def request_download_date(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_download_date() called")
    """Request download date"""

    # TODO: parse res
    return await self.send_command(module="C0", command="RO")

  @action(auto_prefix=True, description="获取验证数据。")
  async def request_verification_data(self, verification_subject: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.request_verification_data() called")
    """Request download date
  ...
  @action(auto_prefix=True, description="获取附加时间戳数据。")
  async def request_additional_timestamp_data(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_additional_timestamp_data() called")
    """Request additional timestamp data"""

    # TODO: parse res
    return await self.send_command(module="C0", command="RS")

  @action(auto_prefix=True, description="获取PIP通道验证状态。")
  async def request_pip_channel_validation_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_pip_channel_validation_status() called")
    """Request PIP channel validation status"""

    # TODO: parse res
    return await self.send_command(module="C0", command="RJ")

  @action(auto_prefix=True, description="获取XL通道验证状态。")
  async def request_xl_channel_validation_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_xl_channel_validation_status() called")
    """Request XL channel validation status"""

    # TODO: parse res
    return await self.send_command(module="C0", command="UJ")

  @action(auto_prefix=True, description="获取机器配置。")
  async def request_machine_configuration(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_machine_configuration() called")
  ...
  async def request_extended_configuration(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_extended_configuration() called")
  ...
  @action(auto_prefix=True, description="获取节点名称。")
  async def request_node_names(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_node_names() called")
    """Request node names"""

    # TODO: parse res
    return await self.send_command(module="C0", command="RK")

  @action(auto_prefix=True, description="获取平台deck数据。")
  async def request_deck_data(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_deck_data() called")
    """Request deck data"""
  ...
  @action(auto_prefix=True, description="定位左X臂。")
  async def position_left_x_arm_(self, x_position: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.position_left_x_arm_() called")
    """Position left X-Arm
  ...
  @action(auto_prefix=True, description="定位右X臂。")
  async def position_right_x_arm_(self, x_position: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.position_right_x_arm_() called")
  ...
  @action(auto_prefix=True, description="在附件处于Z安全位时移动左X臂。")
  async def move_left_x_arm_to_position_with_all_attached_components_in_z_safety_position(
    self, x_position: int = 0
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.move_left_x_arm_to_position_with_all_attached_components_in_z_safety_position() called")
  ...
  @action(auto_prefix=True, description="在附件处于Z安全位时移动右X臂。")
  async def move_right_x_arm_to_position_with_all_attached_components_in_z_safety_position(
    self, x_position: int = 0
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.move_right_x_arm_to_position_with_all_attached_components_in_z_safety_position() called")
  ...
  @action(auto_prefix=True, description="预留区域供外部访问。")
  async def occupy_and_provide_area_for_external_access(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.occupy_and_provide_area_for_external_access() called")
  ...
  @action(auto_prefix=True, description="释放指定预留区域。")
  async def release_occupied_area(self, taken_area_identification_number: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.release_occupied_area() called")
  ...
  @action(auto_prefix=True, description="释放全部预留区域。")
  async def release_all_occupied_areas(self):
    _unilab_logger.debug("[UNILAB] STARBackend.release_all_occupied_areas() called")
  ...
  @action(auto_prefix=True, description="获取右X臂上次碰撞类型。")
  async def request_right_x_arm_last_collision_type(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_right_x_arm_last_collision_type() called")
  ...
  @action(auto_prefix=True, description="初始化移液通道。")
  async def initialize_pip(self):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_pip() called")
  ...
  @action(auto_prefix=True, description="初始化移液通道并处理吸头状态。")
  async def initialize_pipetting_channels(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_pipetting_channels() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="拾取单通道吸头。")
  async def pick_up_tip(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_tip() called")
    """Tip Pick-up
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="丢弃单通道吸头。")
  async def discard_tip(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.discard_tip() called")
    """discard tip
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="执行底层单通道吸液。")
  async def aspirate_pip(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.aspirate_pip() called")
    """aspirate pip
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="执行底层单通道分液。")
  async def dispense_pip(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.dispense_pip() called")
    """dispense pip
  ...
  def _get_core_front_back(self):
    _unilab_logger.debug("[UNILAB] STARBackend._get_core_front_back() called")
  ...
  def _get_core_x(self) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._get_core_x() called")
  ...
  @action(auto_prefix=True, description="获取CoRe组件信息。")
  async def get_core(self, p1: int, p2: int):
    _unilab_logger.debug("[UNILAB] STARBackend.get_core() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="拾取CoRe夹爪工具。")
  async def pick_up_core_gripper_tools(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_core_gripper_tools() called")
  ...
  @action(auto_prefix=True, description="放回CoRe夹爪工具。")
  async def put_core(self):
    _unilab_logger.debug("[UNILAB] STARBackend.put_core() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="归还CoRe夹爪工具。")
  async def return_core_gripper_tools(
    self,
    front_offset: Optional[Coordinate] = None,
    back_offset: Optional[Coordinate] = None,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.return_core_gripper_tools() called")
  ...
  @action(auto_prefix=True, description="打开CoRe夹爪。")
  async def core_open_gripper(self):
    _unilab_logger.debug("[UNILAB] STARBackend.core_open_gripper() called")
    """Open CoRe gripper tool."""
    return await self.send_command(module="C0", command="ZO")

  @need_iswap_parked
  @action(auto_prefix=True, description="用CoRe夹爪抓取板。")
  async def core_get_plate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_get_plate() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="用CoRe夹爪放下板。")
  async def core_put_plate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_put_plate() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="用CoRe夹爪将板移动到指定位置。")
  async def core_move_plate_to_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_move_plate_to_position() called")
  ...
  @action(auto_prefix=True, description="读取CoRe夹持资源的条码。")
  async def core_read_barcode_of_picked_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.core_read_barcode_of_picked_up_resource() called")
  ...
  @action(auto_prefix=True, description="定位单个移液通道Y位置。")
  async def position_single_pipetting_channel_in_y_direction(
    self, pipetting_channel_index: int, y_position: int
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.position_single_pipetting_channel_in_y_direction() called")
  ...
  @action(auto_prefix=True, description="定位单个移液通道Z位置。")
  async def position_single_pipetting_channel_in_z_direction(
    self, pipetting_channel_index: int, z_position: int
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.position_single_pipetting_channel_in_z_direction() called")
  ...
  @action(auto_prefix=True, description="用指定通道沿X方向搜索示教信号。")
  async def search_for_teach_in_signal_using_pipetting_channel_n_in_x_direction(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.search_for_teach_in_signal_using_pipetting_channel_n_in_x_direction() called")
  ...
  @action(auto_prefix=True, description="展开PIP通道间距。")
  async def spread_pip_channels(self):
    _unilab_logger.debug("[UNILAB] STARBackend.spread_pip_channels() called")
    """Spread PIP channels"""

    return await self.send_command(module="C0", command="JE")

  @need_iswap_parked
  @action(auto_prefix=True, description="将所有移液通道移动到指定位置。")
  async def move_all_pipetting_channels_to_defined_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.move_all_pipetting_channels_to_defined_position() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="为指定通道释放最大Y空间。")
  async def position_max_free_y_for_n(self, pipetting_channel_index: int):
    _unilab_logger.debug("[UNILAB] STARBackend.position_max_free_y_for_n() called")
  ...
  @action(auto_prefix=True, description="将所有通道移至Z安全位。")
  async def move_all_channels_in_z_safety(self):
    _unilab_logger.debug("[UNILAB] STARBackend.move_all_channels_in_z_safety() called")
  ...
  @action(auto_prefix=True, description="获取指定通道X位置。")
  async def request_x_pos_channel_n(self, pipetting_channel_index: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_x_pos_channel_n() called")
  ...
  @action(auto_prefix=True, description="获取指定通道Y位置。")
  async def request_y_pos_channel_n(self, pipetting_channel_index: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_y_pos_channel_n() called")
  ...
  @action(auto_prefix=True, description="获取指定通道Z位置。")
  async def request_z_pos_channel_n(self, pipetting_channel_index: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_z_pos_channel_n() called")
    warnings.warn(
  ...
  @action(auto_prefix=True, description="获取吸头底部Z位置。")
  async def request_tip_bottom_z_position(self, channel_idx: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_tip_bottom_z_position() called")
  ...
  @action(auto_prefix=True, description="获取各通道吸头存在状态。")
  async def request_tip_presence(self) -> List[int]:
    _unilab_logger.debug("[UNILAB] STARBackend.request_tip_presence() called")
  ...
  @action(auto_prefix=True, description="检测各通道是否装有吸头。")
  async def channels_sense_tip_presence(self) -> List[int]:
    _unilab_logger.debug("[UNILAB] STARBackend.channels_sense_tip_presence() called")
  ...
  @action(auto_prefix=True, description="获取最近一次LLD液面高度。")
  async def request_pip_height_last_lld(self) -> List[float]:
    _unilab_logger.debug("[UNILAB] STARBackend.request_pip_height_last_lld() called")
    """
  ...
  @action(auto_prefix=True, description="获取TADM状态。")
  async def request_tadm_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_tadm_status() called")
  ...
  @action(auto_prefix=True, description="获取96头固件版本。")
  async def head96_request_firmware_version(self) -> datetime.date:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_request_firmware_version() called")
  ...
  async def _head96_request_configuration(self) -> List[str]:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_request_configuration() called")
  ...
  @action(auto_prefix=True, description="获取96头类型。")
  async def head96_request_type(self) -> Head96Information.HeadType:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_request_type() called")
  ...
  @action(auto_prefix=True, description="初始化CoRe 96头。")
  async def initialize_core_96_head(
    self, trash96: Trash, z_position_at_the_command_end: float = 245.0
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_core_96_head() called")
  ...
  @action(auto_prefix=True, description="获取CoRe 96头初始化状态。")
  async def request_core_96_head_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_core_96_head_initialization_status() called")
  ...
  @action(auto_prefix=True, description="初始化96头分液驱动和压紧驱动。")
  async def head96_dispensing_drive_and_squeezer_driver_initialize(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.head96_dispensing_drive_and_squeezer_driver_initialize() called")
  ...
  def _head96_z_drive_mm_to_increment(self, value_mm: float) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_z_drive_mm_to_increment() called")
  ...
  def _head96_z_drive_increment_to_mm(self, value_increments: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_z_drive_increment_to_mm() called")
  ...
  def _head96_y_drive_mm_to_increment(self, value_mm: float) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_y_drive_mm_to_increment() called")
  ...
  def _head96_y_drive_increment_to_mm(self, value_increments: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_y_drive_increment_to_mm() called")
  ...
  def _head96_dispensing_drive_mm_to_increment(self, value_mm: float) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_mm_to_increment() called")
  ...
  def _head96_dispensing_drive_increment_to_mm(self, value_increments: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_increment_to_mm() called")
  ...
  def _head96_dispensing_drive_uL_to_increment(self, value_uL: float) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_uL_to_increment() called")
  ...
  def _head96_dispensing_drive_increment_to_uL(self, value_increments: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_increment_to_uL() called")
  ...
  def _head96_dispensing_drive_mm_to_uL(self, value_mm: float) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_mm_to_uL() called")
  ...
  def _head96_dispensing_drive_uL_to_mm(self, value_uL: float) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_dispensing_drive_uL_to_mm() called")
  ...
  def _head96_squeezer_drive_mm_to_increment(self, value_mm: float) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_squeezer_drive_mm_to_increment() called")
  ...
  def _head96_squeezer_drive_increment_to_mm(self, value_increments: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend._head96_squeezer_drive_increment_to_mm() called")
  ...
  @action(auto_prefix=True, description="将CoRe 96头移至安全位。")
  async def move_core_96_to_safe_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.move_core_96_to_safe_position() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="将96头移动到Z安全位。")
  async def head96_move_to_z_safety(self):
    _unilab_logger.debug("[UNILAB] STARBackend.head96_move_to_z_safety() called")
    """Move 96-Head to Z safety coordinate, i.e. z=342.5 mm."""
    return await self.send_command(module="C0", command="EV")

  @_requires_head96
  @action(auto_prefix=True, description="停放96头。")
  async def head96_park(
    self,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.head96_park() called")
    """Park the 96-head.
  ...
  @_requires_head96
  @action(auto_prefix=True, description="移动96头X轴。")
  async def head96_move_x(self, x: float):
    _unilab_logger.debug("[UNILAB] STARBackend.head96_move_x() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="移动96头Y轴。")
  async def head96_move_y(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.head96_move_y() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="移动96头Z轴。")
  async def head96_move_z(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.head96_move_z() called")
  ...
  @need_iswap_parked
  @_requires_head96
  @action(auto_prefix=True, description="用CoRe 96头拾取吸头。")
  async def pick_up_tips_core96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pick_up_tips_core96() called")
  ...
  @need_iswap_parked
  @_requires_head96
  @action(auto_prefix=True, description="用CoRe 96头丢弃吸头。")
  async def discard_tips_core96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.discard_tips_core96() called")
  ...
  @action(auto_prefix=True, description="将96头分液驱动移至零体积位。")
  async def head96_dispensing_drive_move_to_home_volume(
    self,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.head96_dispensing_drive_move_to_home_volume() called")
  ...
  @need_iswap_parked
  @_requires_head96
  @action(auto_prefix=True, description="执行底层CoRe 96头吸液。")
  async def aspirate_core_96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.aspirate_core_96() called")
    """aspirate CoRe 96
  ...
  @need_iswap_parked
  @_requires_head96
  @action(auto_prefix=True, description="执行底层CoRe 96头分液。")
  async def dispense_core_96(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.dispense_core_96() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="将CoRe 96头移动到指定位置。")
  async def move_core_96_head_to_defined_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.move_core_96_head_to_defined_position() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="将96头移动到指定坐标。")
  async def head96_move_to_coordinate(
    self,
    coordinate: Coordinate,
    minimum_height_at_beginning_of_a_command: float = 342.5,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.head96_move_to_coordinate() called")
  ...
  @_requires_head96
  @action(auto_prefix=True, description="将96头分液驱动移动到指定位置。")
  async def head96_dispensing_drive_move_to_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.head96_dispensing_drive_move_to_position() called")
  ...
  @action(auto_prefix=True, description="移动CoRe 96头X轴。")
  async def move_core_96_head_x(self, x_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_core_96_head_x() called")
  ...
  @action(auto_prefix=True, description="移动CoRe 96头Y轴。")
  async def move_core_96_head_y(self, y_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_core_96_head_y() called")
  ...
  @action(auto_prefix=True, description="移动CoRe 96头Z轴。")
  async def move_core_96_head_z(self, z_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_core_96_head_z() called")
  ...
  async def move_96head_to_coordinate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.move_96head_to_coordinate() called")
    """Move STAR(let) 96-Head to defined Coordinate
  ...
  @action(auto_prefix=True, description="获取CoRe 96头吸头存在状态。")
  async def request_tip_presence_in_core_96_head(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_tip_presence_in_core_96_head() called")
  ...
  @action(auto_prefix=True, description="获取96头吸头存在状态。")
  async def head96_request_tip_presence(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_request_tip_presence() called")
  ...
  @action(auto_prefix=True, description="获取CoRe 96头位置。")
  async def request_position_of_core_96_head(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_position_of_core_96_head() called")
  ...
  @action(auto_prefix=True, description="获取96头位置。")
  async def head96_request_position(self) -> Coordinate:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_request_position() called")
  ...
  @action(auto_prefix=True, description="获取CoRe 96头TADM状态。")
  async def request_core_96_head_channel_tadm_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_core_96_head_channel_tadm_status() called")
  ...
  @action(auto_prefix=True, description="获取CoRe 96头TADM错误状态。")
  async def request_core_96_head_channel_tadm_error_status(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_core_96_head_channel_tadm_error_status() called")
  ...
  @action(auto_prefix=True, description="获取96头分液驱动位置（毫米）。")
  async def head96_dispensing_drive_request_position_mm(self) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_dispensing_drive_request_position_mm() called")
  ...
  @action(auto_prefix=True, description="获取96头分液驱动位置（微升）。")
  async def head96_dispensing_drive_request_position_uL(self) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.head96_dispensing_drive_request_position_uL() called")
  ...
  @action(auto_prefix=True, description="初始化autoload模块。")
  async def initialize_auto_load(self):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_auto_load() called")
  ...
  async def initialize_autoload(self):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_autoload() called")
    """Initialize Auto load module"""

    return await self.send_command(module="C0", command="II")

  @action(auto_prefix=True, description="将autoload移至Z安全位。")
  async def move_auto_load_to_z_save_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.move_auto_load_to_z_save_position() called")
  ...
  async def move_autoload_to_save_z_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.move_autoload_to_save_z_position() called")
    """Deprecated - use `move_autoload_to_safe_z_position` instead."""
    warnings.warn(  # TODO: remove 2025-02
  ...
  async def move_autoload_to_safe_z_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.move_autoload_to_safe_z_position() called")
    """Move autoload carrier handling wheel to safe Z position"""

    return await self.send_command(module="C0", command="IV")

  @action(auto_prefix=True, description="获取autoload槽位位置。")
  async def request_auto_load_slot_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_auto_load_slot_position() called")
  ...
  @action(auto_prefix=True, description="获取autoload当前轨道。")
  async def request_autoload_track(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.request_autoload_track() called")
  ...
  @action(auto_prefix=True, description="获取autoload模块类型。")
  async def request_autoload_type(self) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.request_autoload_type() called")
    """
  ...
  def _decode_hex_bitmask_to_track_list(self, mask_hex: str) -> list[int]:
    _unilab_logger.debug("[UNILAB] STARBackend._decode_hex_bitmask_to_track_list() called")
    """
  ...
  @action(auto_prefix=True, description="检测deck上载架存在情况。")
  async def request_presence_of_carriers_on_deck(self) -> list[int]:
    _unilab_logger.debug("[UNILAB] STARBackend.request_presence_of_carriers_on_deck() called")
    """
  ...
  @action(auto_prefix=True, description="检测装载托盘上的载架存在情况。")
  async def request_presence_of_carriers_on_loading_tray(self) -> list[int]:
    _unilab_logger.debug("[UNILAB] STARBackend.request_presence_of_carriers_on_loading_tray() called")
    """
  ...
  @action(auto_prefix=True, description="检测托盘指定轨道是否有载架。")
  async def request_presence_of_single_carrier_on_loading_tray(self, track: int) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_presence_of_single_carrier_on_loading_tray() called")
    """
  ...
  @action(auto_prefix=True, description="检测单个载架是否存在。")
  async def request_single_carrier_presence(self, carrier_position: int):
    _unilab_logger.debug("[UNILAB] STARBackend.request_single_carrier_presence() called")
  ...
  def _compute_end_rail_of_carrier(self, carrier: Carrier, track_width: float = 22.5) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend._compute_end_rail_of_carrier() called")
  ...
  @action(auto_prefix=True, description="将autoload移动到指定槽位。")
  async def move_autoload_to_slot(self, slot_number: int):
    _unilab_logger.debug("[UNILAB] STARBackend.move_autoload_to_slot() called")
  ...
  @action(auto_prefix=True, description="将autoload移动到指定轨道。")
  async def move_autoload_to_track(self, track: int):
    _unilab_logger.debug("[UNILAB] STARBackend.move_autoload_to_track() called")
  ...
  @action(auto_prefix=True, description="停放autoload模块。")
  async def park_autoload(self):
    _unilab_logger.debug("[UNILAB] STARBackend.park_autoload() called")
    """Park autoload"""
  ...
  @action(auto_prefix=True, description="将载架送出到autoload识别位。")
  async def take_carrier_out_to_autoload_belt(self, carrier: Carrier):
    _unilab_logger.debug("[UNILAB] STARBackend.take_carrier_out_to_autoload_belt() called")
  ...
  @action(auto_prefix=True, description="设置一维条码类型。")
  async def set_1d_barcode_type(
    self,
    barcode_symbology: Optional[Barcode1DSymbology],
  ) -> None:
    _unilab_logger.debug("[UNILAB] STARBackend.set_1d_barcode_type() called")
  ...
  @action(auto_prefix=True, description="设置条码类型。")
  async def set_barcode_type(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.set_barcode_type() called")
  ...
  @action(auto_prefix=True, description="从托盘装载载架并扫描条码。")
  async def load_carrier_from_tray_and_scan_carrier_barcode(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.load_carrier_from_tray_and_scan_carrier_barcode() called")
  ...
  @action(auto_prefix=True, description="扫描载架条码后卸下载架。")
  async def unload_carrier_after_carrier_barcode_scanning(self):
    _unilab_logger.debug("[UNILAB] STARBackend.unload_carrier_after_carrier_barcode_scanning() called")
  ...
  @action(auto_prefix=True, description="设置载架监控状态。")
  async def set_carrier_monitoring(self, should_monitor: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.set_carrier_monitoring() called")
  ...
  @action(auto_prefix=True, description="从autoload传送带装载载架。")
  async def load_carrier_from_autoload_belt(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.load_carrier_from_autoload_belt() called")
  ...
  @action(auto_prefix=True, description="用autoload装载载架。")
  async def load_carrier(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.load_carrier() called")
    """
  ...
  @action(auto_prefix=True, description="设置装载指示灯状态。")
  async def set_loading_indicators(self, bit_pattern: List[bool], blink_pattern: List[bool]):
    _unilab_logger.debug("[UNILAB] STARBackend.set_loading_indicators() called")
    ...
    def pattern2hex(pattern: List[bool]) -> str:
      _unilab_logger.debug("[UNILAB] STARBackend.pattern2hex() called")
  ...
  @action(auto_prefix=True, description="核验并等待载架到位。")
  async def verify_and_wait_for_carriers(
    self,
    check_interval: float = 1.0,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.verify_and_wait_for_carriers() called")
  ...
  @action(auto_prefix=True, description="用autoload卸下载架。")
  async def unload_carrier(
    self,
    carrier: Carrier,
    park_autoload_after: bool = True,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.unload_carrier() called")
  ...
  @action(auto_prefix=True, description="获取泵站设置。")
  async def request_pump_settings(self, pump_station: int = 1):
    _unilab_logger.debug("[UNILAB] STARBackend.request_pump_settings() called")
    """Set carrier monitoring
  ...
  @action(auto_prefix=True, description="初始化双腔泵站阀门。")
  async def initialize_dual_pump_station_valves(self, pump_station: int = 1):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_dual_pump_station_valves() called")
  ...
  @action(auto_prefix=True, description="填充选定双腔泵腔室。")
  async def fill_selected_dual_chamber(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.fill_selected_dual_chamber() called")
    """Initialize pump station valves (dual chamber only)
  ...
  @action(auto_prefix=True, description="排空双腔泵系统。")
  async def drain_dual_chamber_system(self, pump_station: int = 1):
    _unilab_logger.debug("[UNILAB] STARBackend.drain_dual_chamber_system() called")
  ...
  @action(auto_prefix=True, description="初始化iSWAP机械手。")
  async def initialize_iswap(self):
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_iswap() called")
    """Initialize iSWAP (for standalone configuration only)"""

    return await self.send_command(module="C0", command="FI")

  @action(auto_prefix=True, description="调整部件以释放iSWAP的Y方向空间。")
  async def position_components_for_free_iswap_y_range(self):
    _unilab_logger.debug("[UNILAB] STARBackend.position_components_for_free_iswap_y_range() called")
  ...
  @action(auto_prefix=True, description="相对移动iSWAP X轴。")
  async def move_iswap_x_relative(self, step_size: float, allow_splitting: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_x_relative() called")
    """
    Args:
  ...
  @action(auto_prefix=True, description="相对移动iSWAP Y轴。")
  async def move_iswap_y_relative(self, step_size: float, allow_splitting: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_y_relative() called")
    """
    Args:
  ...
  @action(auto_prefix=True, description="相对移动iSWAP Z轴。")
  async def move_iswap_z_relative(self, step_size: float, allow_splitting: bool = False):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_z_relative() called")
    """
    Args:
  ...
  @action(auto_prefix=True, description="移动iSWAP X轴。")
  async def move_iswap_x(self, x_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_x() called")
  ...
  @action(auto_prefix=True, description="移动iSWAP Y轴。")
  async def move_iswap_y(self, y_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_y() called")
  ...
  @action(auto_prefix=True, description="移动iSWAP Z轴。")
  async def move_iswap_z(self, z_position: float):
    _unilab_logger.debug("[UNILAB] STARBackend.move_iswap_z() called")
  ...
  @action(auto_prefix=True, description="打开未初始化的iSWAP夹爪。")
  async def open_not_initialized_gripper(self):
    _unilab_logger.debug("[UNILAB] STARBackend.open_not_initialized_gripper() called")
    return await self.send_command(module="C0", command="GI")

  @action(auto_prefix=True, description="打开iSWAP夹爪。")
  async def iswap_open_gripper(self, open_position: Optional[float] = None):
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_open_gripper() called")
    """Open gripper
  ...
  @action(auto_prefix=True, description="关闭iSWAP夹爪。")
  async def iswap_close_gripper(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_close_gripper() called")
    """Close gripper
  ...
  @action(auto_prefix=True, description="停放iSWAP机械手。")
  async def park_iswap(
    self,
    minimum_traverse_height_at_beginning_of_a_command: int = 2840,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.park_iswap() called")
    """Close gripper
  ...
  @action(auto_prefix=True, description="用iSWAP抓取板。")
  async def iswap_get_plate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_get_plate() called")
  ...
  @action(auto_prefix=True, description="用iSWAP放下板。")
  async def iswap_put_plate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_put_plate() called")
    """put plate
  ...
  @action(auto_prefix=True, description="获取iSWAP旋转驱动位置增量值。")
  async def request_iswap_rotation_drive_position_increments(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_rotation_drive_position_increments() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP旋转驱动朝向。")
  async def request_iswap_rotation_drive_orientation(self) -> "RotationDriveOrientation":
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_rotation_drive_orientation() called")
    """
  ...
  @action(auto_prefix=True, description="获取iSWAP腕部驱动位置增量值。")
  async def request_iswap_wrist_drive_position_increments(self) -> int:
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_wrist_drive_position_increments() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP腕部驱动朝向。")
  async def request_iswap_wrist_drive_orientation(self) -> "WristDriveOrientation":
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_wrist_drive_orientation() called")
    """
  ...
  @action(auto_prefix=True, description="旋转iSWAP姿态。")
  async def iswap_rotate(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_rotate() called")
    """
  ...
  @action(auto_prefix=True, description="危险地释放iSWAP制动。")
  async def iswap_dangerous_release_break(self):
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_dangerous_release_break() called")
    return await self.send_command(module="R0", command="BA")

  @action(auto_prefix=True, description="重新啮合iSWAP制动。")
  async def iswap_reengage_break(self):
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_reengage_break() called")
    return await self.send_command(module="R0", command="BO")

  @action(auto_prefix=True, description="初始化iSWAP Z轴。")
  async def iswap_initialize_z_axis(self):
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_initialize_z_axis() called")
    return await self.send_command(module="R0", command="ZI")

  @action(auto_prefix=True, description="将板移动到指定位置。")
  async def move_plate_to_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.move_plate_to_position() called")
  ...
  @action(auto_prefix=True, description="收拢iSWAP夹爪臂。")
  async def collapse_gripper_arm(
    self,
    minimum_traverse_height_at_beginning_of_a_command: int = 3600,
    iswap_fold_up_sequence_at_the_end_of_process: bool = False,
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.collapse_gripper_arm() called")
  ...
  @action(auto_prefix=True, description="准备iSWAP示教。")
  async def prepare_iswap_teaching(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.prepare_iswap_teaching() called")
  ...
  @action(auto_prefix=True, description="获取逻辑iSWAP位置。")
  async def get_logic_iswap_position(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.get_logic_iswap_position() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP是否在停放位。")
  async def request_iswap_in_parking_position(self):
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_in_parking_position() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP是否夹持板。")
  async def request_plate_in_iswap(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_plate_in_iswap() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP位置。")
  async def request_iswap_position(self) -> Coordinate:
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_position() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP旋转驱动Y位置。")
  async def iswap_rotation_drive_request_y(self) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.iswap_rotation_drive_request_y() called")
  ...
  @action(auto_prefix=True, description="获取iSWAP初始化状态。")
  async def request_iswap_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_initialization_status() called")
  ...
  async def request_iswap_version(self) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.request_iswap_version() called")
  ...
  @action(auto_prefix=True, description="锁定上盖。")
  async def lock_cover(self):
    _unilab_logger.debug("[UNILAB] STARBackend.lock_cover() called")
    """Lock cover"""

    return await self.send_command(module="C0", command="CO")

  @action(auto_prefix=True, description="解锁上盖。")
  async def unlock_cover(self):
    _unilab_logger.debug("[UNILAB] STARBackend.unlock_cover() called")
    """Unlock cover"""

    return await self.send_command(module="C0", command="HO")

  @action(auto_prefix=True, description="禁用上盖联锁控制。")
  async def disable_cover_control(self):
    _unilab_logger.debug("[UNILAB] STARBackend.disable_cover_control() called")
    """Disable cover control"""

    return await self.send_command(module="C0", command="CD")

  @action(auto_prefix=True, description="启用上盖联锁控制。")
  async def enable_cover_control(self):
    _unilab_logger.debug("[UNILAB] STARBackend.enable_cover_control() called")
    """Enable cover control"""

    return await self.send_command(module="C0", command="CE")

  @action(auto_prefix=True, description="设置上盖输出。")
  async def set_cover_output(self, output: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.set_cover_output() called")
    """Set cover output
  ...
  @action(auto_prefix=True, description="复位指定输出。")
  async def reset_output(self, output: int = 0):
    _unilab_logger.debug("[UNILAB] STARBackend.reset_output() called")
    """Reset output
  ...
  @action(auto_prefix=True, description="获取上盖开启状态。")
  async def request_cover_open(self) -> bool:
    _unilab_logger.debug("[UNILAB] STARBackend.request_cover_open() called")
    """Request cover open
  ...
  async def clld_probe_x_position_using_channel(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.clld_probe_x_position_using_channel() called")
    """
  ...
  @action(auto_prefix=True, description="用通道cLLD沿Y方向探测位置。")
  async def clld_probe_y_position_using_channel(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.clld_probe_y_position_using_channel() called")
    """
  ...
  async def _move_z_drive_to_liquid_surface_using_clld(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend._move_z_drive_to_liquid_surface_using_clld() called")
  ...
  @action(auto_prefix=True, description="用通道cLLD探测液面Z高度。")
  async def clld_probe_z_height_using_channel(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.clld_probe_z_height_using_channel() called")
  ...
  async def _search_for_surface_using_plld(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend._search_for_surface_using_plld() called")
  ...
  @action(auto_prefix=True, description="用通道pLLD探测液面Z高度。")
  async def plld_probe_z_height_using_channel(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.plld_probe_z_height_using_channel() called")
  ...
  @action(auto_prefix=True, description="获取通道探针Z位置。")
  async def request_probe_z_position(self, channel_idx: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_probe_z_position() called")
  ...
  @action(auto_prefix=True, description="测量通道上的吸头长度。")
  async def request_tip_len_on_channel(self, channel_idx: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_tip_len_on_channel() called")
  ...
  @action(auto_prefix=True, description="用Z触碰方式探测Z高度。")
  async def ztouch_probe_z_height_using_channel(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.ztouch_probe_z_height_using_channel() called")
  ...
  @action(auto_prefix=True, description="旋转iSWAP旋转驱动。")
  async def rotate_iswap_rotation_drive(self, orientation: RotationDriveOrientation):
    _unilab_logger.debug("[UNILAB] STARBackend.rotate_iswap_rotation_drive() called")
    if orientation in {
  ...
  @action(auto_prefix=True, description="旋转iSWAP腕部。")
  async def rotate_iswap_wrist(self, orientation: WristDriveOrientation):
    _unilab_logger.debug("[UNILAB] STARBackend.rotate_iswap_wrist() called")
    return await self.send_command(
      module="R0",
      command="TP",
      auto_id=False,
  ...
  @staticmethod
  @action(auto_prefix=True, description="获取通道标识。")
  def channel_id(channel_idx: int) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.channel_id() called")
    """channel_idx: plr style, 0-indexed from the back"""
    channel_ids = "123456789ABCDEFG"
    return "P" + channel_ids[channel_idx]

  @action(auto_prefix=True, description="获取所有通道Y位置。")
  async def get_channels_y_positions(self) -> Dict[int, float]:
    _unilab_logger.debug("[UNILAB] STARBackend.get_channels_y_positions() called")
  ...
  @need_iswap_parked
  @action(auto_prefix=True, description="设置多个通道Y位置。")
  async def position_channels_in_y_direction(self, ys: Dict[int, float], make_space=True):
    _unilab_logger.debug("[UNILAB] STARBackend.position_channels_in_y_direction() called")
  ...
  @action(auto_prefix=True, description="获取所有通道Z位置。")
  async def get_channels_z_positions(self) -> Dict[int, float]:
    _unilab_logger.debug("[UNILAB] STARBackend.get_channels_z_positions() called")
    """Get the Y position of all channels in mm"""
    resp = await self.send_command(
      module="C0",
      command="RZ",
  ...
  @action(auto_prefix=True, description="设置多个通道Z位置。")
  async def position_channels_in_z_direction(self, zs: Dict[int, float]):
    _unilab_logger.debug("[UNILAB] STARBackend.position_channels_in_z_direction() called")
  ...
  @action(auto_prefix=True, description="刺穿板封膜。")
  async def pierce_foil(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.pierce_foil() called")
  ...
  @action(auto_prefix=True, description="从封膜边缘脱离通道。")
  async def step_off_foil(
    ...
    _unilab_logger.debug("[UNILAB] STARBackend.step_off_foil() called")
    """
  ...
  @action(auto_prefix=True, description="获取吸头内体积。")
  async def request_volume_in_tip(self, channel: int) -> float:
    _unilab_logger.debug("[UNILAB] STARBackend.request_volume_in_tip() called")
  ...
  @asynccontextmanager
  @action(auto_prefix=True, description="临时降低iSWAP速度。")
  async def slow_iswap(self, wrist_velocity: int = 20_000, gripper_velocity: int = 20_000):
    _unilab_logger.debug("[UNILAB] STARBackend.slow_iswap() called")
  ...
  @action(auto_prefix=True, description="向HHS模块发送命令。")
  async def send_hhs_command(self, index: int, command: str, **kwargs) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.send_hhs_command() called")
    resp = await self.send_command(
      module=f"T{index}",
      command=command,
      **kwargs,
  ...
  @action(auto_prefix=True, description="检查连接设备是否为HHC模块。")
  async def check_type_is_hhc(self, device_number: int):
    _unilab_logger.debug("[UNILAB] STARBackend.check_type_is_hhc() called")
    """
  ...
  @action(auto_prefix=True, description="初始化HHC加热冷却模块。")
  async def initialize_hhc(self, device_number: int) -> str:
    _unilab_logger.debug("[UNILAB] STARBackend.initialize_hhc() called")
  ...
  @action(auto_prefix=True, description="启动HHC温控。")
  async def start_temperature_control_at_hhc(
    self,
    device_number: int,
    temp: Union[float, int],
  ):
    _unilab_logger.debug("[UNILAB] STARBackend.start_temperature_control_at_hhc() called")
  ...
  @action(auto_prefix=True, description="获取HHC温度。")
  async def get_temperature_at_hhc(self, device_number: int) -> dict:
    _unilab_logger.debug("[UNILAB] STARBackend.get_temperature_at_hhc() called")
  ...
  @action(auto_prefix=True, description="查询HHC是否达到目标温度。")
  async def query_whether_temperature_reached_at_hhc(self, device_number: int):
    _unilab_logger.debug("[UNILAB] STARBackend.query_whether_temperature_reached_at_hhc() called")
  ...
  @action(auto_prefix=True, description="停止HHC温控。")
  async def stop_temperature_control_at_hhc(self, device_number: int):
    _unilab_logger.debug("[UNILAB] STARBackend.stop_temperature_control_at_hhc() called")
    """Stop temperature regulation of specified HHC"""

    await self.check_type_is_hhc(device_number)

    return await self.send_command(module=f"T{device_number}", command="TO")
  @action(auto_prefix=True, description="将资源放入hotel位。")
  async def put_in_hotel(
    ...
    return await self.unsafe.put_in_hotel(hotel_center_x_coord, hotel_center_y_coord, hotel_center_z_coord, hotel_center_x_direction, hotel_center_y_direction, hotel_center_z_direction, clearance_height, hotel_depth, grip_direction, traverse_height_at_beginning, z_position_at_end, grip_strength, open_gripper_position, collision_control, high_acceleration_index, low_acceleration_index, fold_up_at_end)

  @action(auto_prefix=True, description="从hotel位取出资源。")
  async def get_from_hotel(
    ...
    return await self.unsafe.get_from_hotel(hotel_center_x_coord, hotel_center_y_coord, hotel_center_z_coord, hotel_center_x_direction, hotel_center_y_direction, hotel_center_z_direction, clearance_height, hotel_depth, grip_direction, traverse_height_at_beginning, z_position_at_end, grip_strength, open_gripper_position, plate_width, plate_width_tolerance, collision_control, high_acceleration_index, low_acceleration_index, fold_up_at_end)

  @action(auto_prefix=True, description="强制弹出吸头。")
  async def violently_shoot_down_tip(self, channel_idx: int):
    return await self.unsafe.violently_shoot_down_tip(channel_idx)
