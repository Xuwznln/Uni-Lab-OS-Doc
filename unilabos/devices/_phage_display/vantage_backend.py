...
Original: pylabrobot/liquid_handling/backends/hamilton/vantage_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VantageBackend")
...
class VantageBackend(HamiltonLiquidHandler):
  ...
  def __init__(
    ...
    print("[UNILAB] VantageBackend.__init__() called", flush=True)
  ...
  def module_id_length(self) -> int:
    _unilab_logger.debug("[UNILAB] VantageBackend.module_id_length() called")
    return 4

  @action(auto_prefix=True, description="获取固件响应中的模块 ID")
  def get_id_from_fw_response(self, resp: str) -> Optional[int]:
    _unilab_logger.debug("[UNILAB] VantageBackend.get_id_from_fw_response() called")
  ...
  @action(auto_prefix=True, description="检查固件响应是否包含错误")
  def check_fw_string_error(self, resp: str):
    _unilab_logger.debug("[UNILAB] VantageBackend.check_fw_string_error() called")
  ...
  def _parse_response(self, resp: str, fmt: Dict[str, str]) -> dict:
    _unilab_logger.debug("[UNILAB] VantageBackend._parse_response() called")
    """Parse a firmware response."""
    return parse_vantage_fw_string(resp, fmt)

  @action(auto_prefix=True, description="连接并设置 Vantage 系统")
  async def setup(
    self,
  ...
  @property
  @action(auto_prefix=True, description="获取通道数量")
  def num_channels(self) -> int:
    _unilab_logger.debug("[UNILAB] VantageBackend.num_channels() called")
  ...
  def set_minimum_traversal_height(self, traversal_height: float):
    _unilab_logger.debug("[UNILAB] VantageBackend.set_minimum_traversal_height() called")
  ...
  @action(auto_prefix=True, description="使用选定通道拾取吸头")
  async def pick_up_tips(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pick_up_tips() called")
  ...
  # @need_iswap_parked
  @action(auto_prefix=True, description="丢弃吸头到目标资源")
  async def drop_tips(
    self,
    ops: List[Drop],
    use_channels: List[int],
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.drop_tips() called")
  ...
  def _assert_valid_resources(self, resources: Sequence[Resource]) -> None:
    _unilab_logger.debug("[UNILAB] VantageBackend._assert_valid_resources() called")
  ...
  @action(auto_prefix=True, description="使用移液通道吸液")
  async def aspirate(
    self,
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.aspirate() called")
  ...
  @action(auto_prefix=True, description="使用移液通道分液")
  async def dispense(
    self,
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.dispense() called")
  ...
  @action(auto_prefix=True, description="使用96头拾取吸头")
  async def pick_up_tips96(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pick_up_tips96() called")
  ...
  @action(auto_prefix=True, description="使用96头弃去吸头")
  async def drop_tips96(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.drop_tips96() called")
    # assert self.core96_head_installed, "96 head must be installed"
  ...
  @action(auto_prefix=True, description="使用96头从板中吸液")
  async def aspirate96(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.aspirate96() called")
  ...
  @action(auto_prefix=True, description="使用96头向板中分液")
  async def dispense96(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.dispense96() called")
  ...
  @action(auto_prefix=True, description="使用 IPG 夹取实验资源")
  async def pick_up_resource(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pick_up_resource() called")
  ...
  @action(auto_prefix=True, description="移动当前已夹取的实验资源")
  async def move_picked_up_resource(self, move: ResourceMove):
    _unilab_logger.debug("[UNILAB] VantageBackend.move_picked_up_resource() called")
  ...
  @action(auto_prefix=True, description="放下已夹持的实验资源")
  async def drop_resource(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.drop_resource() called")
  ...
  @action(auto_prefix=True, description="使指定通道准备好手动操作")
  async def prepare_for_manual_channel_operation(self, channel: int):
    _unilab_logger.debug("[UNILAB] VantageBackend.prepare_for_manual_channel_operation() called")
    """Prepare the robot for manual operation."""

    return await self.expose_channel_n(channel_index=channel + 1)  # ?

  @action(auto_prefix=True, description="将指定通道移动到 X 坐标")
  async def move_channel_x(self, channel: int, x: float):
    _unilab_logger.debug("[UNILAB] VantageBackend.move_channel_x() called")
    """Move the specified channel to the specified x coordinate."""

    return await self.x_arm_move_to_x_position(round(x * 10))

  @action(auto_prefix=True, description="将指定通道移动到 Y 坐标")
  async def move_channel_y(self, channel: int, y: float):
    _unilab_logger.debug("[UNILAB] VantageBackend.move_channel_y() called")
  ...
  @action(auto_prefix=True, description="将指定通道移动到 Z 坐标")
  async def move_channel_z(self, channel: int, z: float):
    _unilab_logger.debug("[UNILAB] VantageBackend.move_channel_z() called")
  ...
  @action(auto_prefix=True, description="检查通道是否可以拾取吸头")
  def can_pick_up_tip(self, channel_idx: int, tip: Tip) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.can_pick_up_tip() called")
  ...
  @action(auto_prefix=True, description="设置 LED 颜色与闪烁模式")
  async def set_led_color(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.set_led_color() called")
    """Set the LED color.
  ...
  @action(auto_prefix=True, description="打开或关闭上样盖")
  async def set_loading_cover(self, cover_open: bool):
    _unilab_logger.debug("[UNILAB] VantageBackend.set_loading_cover() called")
  ...
  @action(auto_prefix=True, description="获取上样盖初始化状态")
  async def loading_cover_request_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.loading_cover_request_initialization_status() called")
  ...
  @action(auto_prefix=True, description="初始化上样盖")
  async def loading_cover_initialize(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.loading_cover_initialize() called")
  ...
  @action(auto_prefix=True, description="获取机械臂模块初始化状态")
  async def arm_request_instrument_initialization_status(
    self,
  ) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.arm_request_instrument_initialization_status() called")
  ...
  @action(auto_prefix=True, description="预初始化机械臂模块")
  async def arm_pre_initialize(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.arm_pre_initialize() called")
    """Initialize the arm module."""

    return await self.send_command(module="A1AM", command="MI")

  @action(auto_prefix=True, description="获取移液模块初始化状态")
  async def pip_request_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_request_initialization_status() called")
  ...
  @action(auto_prefix=True, description="初始化移液模块")
  async def pip_initialize(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_initialize() called")
    """Initialize
  ...
  @action(auto_prefix=True, description="定义吸头或针的参数")
  async def define_tip_needle(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.define_tip_needle() called")
  ...
  @action(auto_prefix=True, description="使用移液模块吸液")
  async def pip_aspirate(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_aspirate() called")
  ...
  @action(auto_prefix=True, description="使用移液模块分液")
  async def pip_dispense(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_dispense() called")
  ...
  @action(auto_prefix=True, description="执行同步吸液与分液")
  async def simultaneous_aspiration_dispensation_of_liquid(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.simultaneous_aspiration_dispensation_of_liquid() called")
  ...
  @action(auto_prefix=True, description="在运动过程中进行飞行分液")
  async def dispense_on_fly(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.dispense_on_fly() called")
    """Dispense on fly
  ...
  @action(auto_prefix=True, description="执行纳升级脉冲分液")
  async def nano_pulse_dispense(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.nano_pulse_dispense() called")
    """Nano pulse dispense
  ...
  @action(auto_prefix=True, description="清洗吸头")
  async def wash_tips(
    self,
    x_position: List[int],
    y_position: List[int],
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.wash_tips() called")
    """Wash tips
  ...
  @action(auto_prefix=True, description="使用移液模块拾取吸头")
  async def pip_tip_pick_up(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_tip_pick_up() called")
    """Tip Pick up
  ...
  @action(auto_prefix=True, description="使用移液模块弃去吸头")
  async def pip_tip_discard(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.pip_tip_discard() called")
    """Tip Discard
  ...
  @action(auto_prefix=True, description="在 X 方向搜索示教信号")
  async def search_for_teach_in_signal_in_x_direction(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.search_for_teach_in_signal_in_x_direction() called")
  ...
  @action(auto_prefix=True, description="将所有通道移动到同一 Y 位置")
  async def position_all_channels_in_y_direction(
    self,
    y_position: List[int],
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.position_all_channels_in_y_direction() called")
  ...
  @action(auto_prefix=True, description="将所有通道移动到同一 Z 位置")
  async def position_all_channels_in_z_direction(
    self,
    z_position: Optional[List[int]] = None,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.position_all_channels_in_z_direction() called")
  ...
  @action(auto_prefix=True, description="将单个通道移动到 Y 位置")
  async def position_single_channel_in_y_direction(
    self,
    channel_index: int = 1,
    y_position: int = 3000,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.position_single_channel_in_y_direction() called")
  ...
  @action(auto_prefix=True, description="将单个通道移动到 Z 位置")
  async def position_single_channel_in_z_direction(
    self,
    channel_index: int = 1,
    z_position: int = 0,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.position_single_channel_in_z_direction() called")
  ...
  @action(auto_prefix=True, description="将移液模块移动到指定位置")
  async def move_to_defined_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.move_to_defined_position() called")
  ...
  @action(auto_prefix=True, description="使用指定通道对架位进行示教")
  async def teach_rack_using_channel_n(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.teach_rack_using_channel_n() called")
  ...
  @action(auto_prefix=True, description="暴露指定通道")
  async def expose_channel_n(
    self,
    channel_index: int = 1,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.expose_channel_n() called")
    """Expose channel n
  ...
  @action(auto_prefix=True, description="计算校验和并与 Flash EPROM 中保存的数值比较")
  async def calculates_check_sums_and_compares_them_with_the_value_saved_in_flash_eprom(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.calculates_check_sums_and_compares_them_with_the_value_saved_in_flash_eprom() called")
  ...
  @action(auto_prefix=True, description="弃去 CoRe 夹爪工具")
  async def discard_core_gripper_tool(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.discard_core_gripper_tool() called")
  ...
  @action(auto_prefix=True, description="夹取微孔板")
  async def grip_plate(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.grip_plate() called")
    """Grip plate
  ...
  @action(auto_prefix=True, description="放置微孔板")
  async def put_plate(
    self,
    plate_center_x_direction: int = 0,
    plate_center_y_direction: int = 3000,
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.put_plate() called")
    """Put plate
  ...
  @action(auto_prefix=True, description="将夹爪移动到指定板位")
  async def move_to_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.move_to_position() called")
    """Move to position
  ...
  @action(auto_prefix=True, description="释放当前夹持的物体")
  async def release_object(
    self,
    first_pip_channel_node_no: int = 1,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.release_object() called")
    """Release object
  ...
  @action(auto_prefix=True, description="设置本模块参数")
  async def set_any_parameter_within_this_module(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.set_any_parameter_within_this_module() called")
  ...
  @action(auto_prefix=True, description="获取所有通道的 Y 位置")
  async def request_y_positions_of_all_channels(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_y_positions_of_all_channels() called")
  ...
  @action(auto_prefix=True, description="获取指定通道的 Y 位置")
  async def request_y_position_of_channel_n(self, channel_index: int = 1):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_y_position_of_channel_n() called")
  ...
  @action(auto_prefix=True, description="获取所有通道的 Z 位置")
  async def request_z_positions_of_all_channels(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_z_positions_of_all_channels() called")
  ...
  @action(auto_prefix=True, description="获取指定通道的 Z 位置")
  async def request_z_position_of_channel_n(self, channel_index: int = 1):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_z_position_of_channel_n() called")
  ...
  @action(auto_prefix=True, description="查询移液通道的吸头在位状态")
  async def query_tip_presence(self) -> List[bool]:
    _unilab_logger.debug("[UNILAB] VantageBackend.query_tip_presence() called")
    """Query Tip presence"""
  ...
  @action(auto_prefix=True, description="获取上一次液面探测高度")
  async def request_height_of_last_lld(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_height_of_last_lld() called")
  ...
  @action(auto_prefix=True, description="获取通道飞行分液状态")
  async def request_channel_dispense_on_fly_status(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.request_channel_dispense_on_fly_status() called")
  ...
  @action(auto_prefix=True, description="获取 CoRe96 头初始化状态")
  async def core96_request_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_request_initialization_status() called")
  ...
  @action(auto_prefix=True, description="初始化 CoRe96 头")
  async def core96_initialize(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_initialize() called")
    """Initialize 96 head.
  ...
  @action(auto_prefix=True, description="使用 CoRe96 头吸液")
  async def core96_aspiration_of_liquid(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_aspiration_of_liquid() called")
  ...
  @action(auto_prefix=True, description="使用 CoRe96 头分液")
  async def core96_dispensing_of_liquid(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_dispensing_of_liquid() called")
  ...
  @action(auto_prefix=True, description="使用 CoRe96 头拾取吸头")
  async def core96_tip_pick_up(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_tip_pick_up() called")
  ...
  @action(auto_prefix=True, description="使用 CoRe96 头弃去吸头")
  async def core96_tip_discard(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_tip_discard() called")
  ...
  @action(auto_prefix=True, description="将 CoRe96 头移动到指定位置")
  async def core96_move_to_defined_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_move_to_defined_position() called")
  ...
  @action(auto_prefix=True, description="清洗 CoRe96 头上的吸头")
  async def core96_wash_tips(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_wash_tips() called")
  ...
  @action(auto_prefix=True, description="排空 CoRe96 头已清洗吸头中的残液")
  async def core96_empty_washed_tips(
    self,
    liquid_surface_at_function_without_lld: int = 3900,
    minimal_height_at_command_end: int = 3900,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_empty_washed_tips() called")
  ...
  @action(auto_prefix=True, description="使用 CoRe96 头在 X 方向搜索示教信号")
  async def core96_search_for_teach_in_signal_in_x_direction(
    self,
    x_search_distance: int = 0,
    x_speed: int = 50,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_search_for_teach_in_signal_in_x_direction() called")
  ...
  @action(auto_prefix=True, description="设置 CoRe96 模块参数")
  async def core96_set_any_parameter(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_set_any_parameter() called")
  ...
  @action(auto_prefix=True, description="查询 CoRe96 头的吸头在位状态")
  async def core96_query_tip_presence(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_query_tip_presence() called")
  ...
  @action(auto_prefix=True, description="获取 CoRe96 头位置")
  async def core96_request_position(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_request_position() called")
  ...
  @action(auto_prefix=True, description="获取 CoRe96 头 TADM 错误状态")
  async def core96_request_tadm_error_status(
    self,
    tadm_channel_pattern: Optional[List[bool]] = None,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.core96_request_tadm_error_status() called")
  ...
  @action(auto_prefix=True, description="获取 IPG 初始化状态")
  async def ipg_request_initialization_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_request_initialization_status() called")
  ...
  @action(auto_prefix=True, description="初始化 IPG 夹爪")
  async def ipg_initialize(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_initialize() called")
    """Initialize IPG"""
  ...
  @action(auto_prefix=True, description="停泊 IPG")
  async def ipg_park(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_park() called")
    """Park IPG"""
  ...
  @action(auto_prefix=True, description="暴露指定 IPG 通道")
  async def ipg_expose_channel_n(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_expose_channel_n() called")
    """Expose channel n"""
  ...
  @action(auto_prefix=True, description="释放 IPG 当前夹持的物体")
  async def ipg_release_object(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_release_object() called")
    """Release object"""
  ...
  @action(auto_prefix=True, description="使用 IPG 在 X 方向搜索示教信号")
  async def ipg_search_for_teach_in_signal_in_x_direction(
    self,
    x_search_distance: int = 0,
    x_speed: int = 50,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_search_for_teach_in_signal_in_x_direction() called")
    """Search for Teach in signal in X direction
  ...
  @action(auto_prefix=True, description="使用 IPG 夹取微孔板")
  async def ipg_grip_plate(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_grip_plate() called")
    """Grip plate
  ...
  @action(auto_prefix=True, description="使用 IPG 放置微孔板")
  async def ipg_put_plate(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_put_plate() called")
    """Put plate
  ...
  @action(auto_prefix=True, description="设置 IPG 夹爪方向")
  async def ipg_prepare_gripper_orientation(
    self,
    grip_orientation: int = 32,
    minimal_traverse_height_at_begin_of_command: int = 3600,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_prepare_gripper_orientation() called")
  ...
  @action(auto_prefix=True, description="将 IPG 移动到指定位置")
  async def ipg_move_to_defined_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_move_to_defined_position() called")
    """Move to defined position
  ...
  @action(auto_prefix=True, description="设置 IPG 模块参数")
  async def ipg_set_any_parameter_within_this_module(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_set_any_parameter_within_this_module() called")
    """Set any parameter within this module"""
  ...
  @action(auto_prefix=True, description="获取 IPG 停泊状态")
  async def ipg_get_parking_status(self) -> bool:
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_get_parking_status() called")
  ...
  @action(auto_prefix=True, description="查询 IPG 模块的吸头在位状态")
  async def ipg_query_tip_presence(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_query_tip_presence() called")
    """Query Tip presence"""
  ...
  @action(auto_prefix=True, description="获取 IPG 可达范围")
  async def ipg_request_access_range(self, grip_orientation: int = 32):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_request_access_range() called")
  ...
  @action(auto_prefix=True, description="获取 IPG 位置")
  async def ipg_request_position(self, grip_orientation: int = 32):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_request_position() called")
    """Request position
  ...
  async def ipg_request_actual_angular_dimensions(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_request_actual_angular_dimensions() called")
  ...
  @action(auto_prefix=True, description="获取 IPG 配置")
  async def ipg_request_configuration(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.ipg_request_configuration() called")
  ...
  @action(auto_prefix=True, description="初始化 X 轴机械臂")
  async def x_arm_initialize(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_initialize() called")
    """Initialize the x arm"""
    return await self.send_command(module="A1XM", command="XI")

  @action(auto_prefix=True, description="将 X 轴机械臂移动到指定 X 位置")
  async def x_arm_move_to_x_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_move_to_x_position() called")
  ...
  @action(auto_prefix=True, description="在所有附属部件处于安全 Z 位时移动 X 轴机械臂")
  async def x_arm_move_to_x_position_with_all_attached_components_in_z_safety_position(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_move_to_x_position_with_all_attached_components_in_z_safety_position() called")
  ...
  @action(auto_prefix=True, description="使 X 轴机械臂相对移动")
  async def x_arm_move_arm_relatively_in_x(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_move_arm_relatively_in_x() called")
  ...
  @action(auto_prefix=True, description="让 X 轴机械臂搜索示教信号")
  async def x_arm_search_x_for_teach_signal(
    ...
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_search_x_for_teach_signal() called")
  ...
  @action(auto_prefix=True, description="设置 X 驱动对准角度")
  async def x_arm_set_x_drive_angle_of_alignment(
    self,
    TODO_XL_1: int = 1,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_set_x_drive_angle_of_alignment() called")
  ...
  @action(auto_prefix=True, description="关闭 X 驱动")
  async def x_arm_turn_x_drive_off(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_turn_x_drive_off() called")
    return await self.send_command(module="A1XM", command="XO")

  @action(auto_prefix=True, description="向运动控制器发送消息")
  async def x_arm_send_message_to_motion_controller(
    self,
    TODO_BD_1: str = "",
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_send_message_to_motion_controller() called")
  ...
  @action(auto_prefix=True, description="设置 X 轴机械臂模块参数")
  async def x_arm_set_any_parameter_within_this_module(
    self,
    TODO_AA_1: int = 0,
    TODO_AA_2: int = 1,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_set_any_parameter_within_this_module() called")
    """Set any parameter within this module
  ...
  @action(auto_prefix=True, description="获取 X 轴机械臂位置")
  async def x_arm_request_arm_x_position(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_request_arm_x_position() called")
  ...
  @action(auto_prefix=True, description="获取 X 轴机械臂错误代码")
  async def x_arm_request_error_code(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_request_error_code() called")
    """X arm request error code"""
    return await self.send_command(module="A1XM", command="RE")

  @action(auto_prefix=True, description="获取 X 驱动记录数据")
  async def x_arm_request_x_drive_recorded_data(
    self,
    TODO_QL_1: int = 0,
    TODO_QL_2: int = 0,
  ):
    _unilab_logger.debug("[UNILAB] VantageBackend.x_arm_request_x_drive_recorded_data() called")
  ...
  @action(auto_prefix=True, description="启动迪斯科彩蛋模式")
  async def disco_mode(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.disco_mode() called")
    """Easter egg."""
    for _ in range(69):
      r, g, b = (
  ...
  @action(auto_prefix=True, description="触发危险的轮盘彩蛋模式")
  async def russian_roulette(self):
    _unilab_logger.debug("[UNILAB] VantageBackend.russian_roulette() called")
